...
|---|---|---|
| 0 | Executive Summary | The central finding and analytical framework at a glance |
| 1 | The Paradox | Bilateral comparison of prevalence and mortality, evidencing the counterintuitive divergence |
| 2 | The System Failures | Three measurable gaps quantified through the diabetes care cascade |
| 3 | The Human Cost | System-level gaps examined at the individual level - discontinuity, medication safety, and care fragmentation |
...
- Three system-level gaps are associated with Nigeria's outcomes: **diagnostic coverage, treatment access, and workforce capacity**
- Evidence from WHO indicates that up to **~80%** of preventable medication errors in low-resource settings originate at the prescribing stage, with a substantial proportion considered preventable through structured protocols
...
*Full citations with DOIs are on the Methods page.*

**Primary global datasets**
IDF Diabetes Atlas 11th Edition · 2024 · IHME GBD 2023 · WHO Global Health Observatory

**International institutional data**
World Bank · WHO Global Patient Safety Report 2024

**National institutional data**
Public Health Agency of Canada · CMA / Canada Health Infoway · Accreditation Canada / ISMP Canada · Gartner / Canada Health Infoway
...
| Tool | Purpose |
|---|---|
| Power BI Desktop | Dashboard design, data visualisation, DAX measures |
